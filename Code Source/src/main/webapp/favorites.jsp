...
<body>
  ...
  <div class="text-on-image"> <%=auth.getName() %>'s Favorite Books. </div>
</div>

	<div class="container my-3">
		<div class="d-flex py-3"><h3>Favorites :  </h3> </div>
		<table class="table table-light">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="rem-fav?id=<%=c.getId() %>" class="btn btn-sm btn-danger">Remove</a></td>
				</tr>
